...
## Personal Tutorials Taken

- [Hands On ML O'Reilly](https://github.com/ageron/handson-ml) - Basic Guidlines for ML, from the book of the same name
- [Lazy Programmer Tuts](https://github.com/lazyprogrammer/machine_learning_examples) - Based on the course given by the Lazy Programmer
